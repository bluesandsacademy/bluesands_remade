        ...
        <div className="w-full h-full flex items-center justify-center">
            <div className="w-full h-full container bg-[url('/background/blocks.png')] bg-cover bg-center flex items-center justify-center md:flex-row flex-col mx-auto">
                ...
                <div className="md:w-8/12 w-full h-full md:flex hidden flex-col justify-center md:px-0 px-3">
                    <h1 className="md:text-6xl text-4xl font-bold relative">Virtual & Augmented <Image src="/icons/little vr user.png" className="absolute -top-6 right-16 z-10" alt="VR" width={95} height={95} /> Reality <br className="hidden md:block" /> in 
                ...
                <div className="md:w-8/12 w-full h-full md:hidden flex flex-col justify-center md:px-0 px-3 gap-y-5 py-10">
                    <h1 className="text-2xl font-bold relative">Virtual & Augmented <Image src="/icons/little vr user.png" className="absolute -top-2 -right-2 z-10" alt="VR" width={40} height={40} /> Reality in <br /> <span className="bg-blue-500 text-white px-5 py-1 rounded-full inline-flex items-center gap-x-2 mx-1 shadow-md"><FaArrowRightLong className="inline-block text-white" size={18} /> </span>STEM Education for Secondary Schools.</h1>
